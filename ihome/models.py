...
class BaseModel:
    ...
    update_time = db.Column(db.DateTime, default=datetime.now, onupdate=datetime.now)  # 记录的最近一次更新时间
...
house_facility = db.Table(
    'ih_house_facility',
    db.Column('hourse_id', db.Integer, db.ForeignKey('ih_house_info.id'), primary_key=True),  # 房屋编号

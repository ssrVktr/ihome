...
Revision ID: d14a74340f80
Revises: 
Create Date: 2018-12-18 10:44:35.561688
...
def upgrade():
    ...
    sa.Column('hourse_id', sa.Integer(), nullable=False),
    sa.Column('facility_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['facility_id'], ['ih_facility_info.id'], ),
    sa.ForeignKeyConstraint(['hourse_id'], ['ih_house_info.id'], ),
    sa.PrimaryKeyConstraint('hourse_id', 'facility_id')
    )
